...
// Step 2:
export const firstName = "Carlos";
export const lastName = "Stevenson";
export const birthYear = 1948;
export const thisYear = 1965;
export const testGroup = "b";
export const age = thisYear - birthYear;
export const greeting = `Hello! My name is ${firstName} ${lastName} and I am ${age} years old.`;
